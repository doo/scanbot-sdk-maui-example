...
public static class Alert
{
    ...
    {
        await MainThread.InvokeOnMainThreadAsync(async () => await App.Navigation.CurrentPage.DisplayAlert(title, message, button));
    }
    ...
    {
        return await MainThread.InvokeOnMainThreadAsync(async () => await App.Navigation.CurrentPage.DisplayAlert(title, message, accept, reject));
    }
