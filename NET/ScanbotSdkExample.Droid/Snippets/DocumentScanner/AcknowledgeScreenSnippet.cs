...
public class AcknowledgementScreenSnippet : AppCompatActivity
{
    ...
    private void LaunchDocumentScanner()
    {
        ...
        // todo: Check why this is getter only. OR Check newer RC.
        // configuration.Screens.Camera.DocumentQualityAnalyzerConfiguration.QualityAcceptableUncertainThreshold = 0.75;
        ...
        // todo: Check for this missing property OR Check newer RC.
