...
namespace ReadyToUseUI.Droid
{
    ...
    public partial class MainActivity : AndroidX.AppCompat.App.AppCompatActivity
    {
        ...
        private const int ImportImageRequest = 2001;
        private const int ScanMrzRequest = 4001;
        private const int ExtractDocumentDataRequest = 4002;
        private const int ScanDataRequest = 4003;
        private const int ScanVinRequest = 4004;
        private const int ScanCreditCardRequest = 4005;
        private const int ScanEhicRequest = 4006;
        private const int ScanMedicalCertificateRequest = 4007;
        private const int ScanCheckRequest = 4008;
        private const int DetectMrzFromImage = 6001;
        private const int DetectEhicFromImage = 6002;
        private const int DetectMedicalCertificateFromImage = 6003;
        private const int DetectCheckFromImage = 6004;
        private const int DetectDocumentDataFromImage = 6005;
        private const int DetectCreditCardFromImage = 6006;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            detectionOnImage.AddChildren(_buttons, [
                new ListItemButton(this, "Detect Check on Image", () => LaunchImagePicker(DetectCheckFromImage)),
                new ListItemButton(this, "Detect Credit Card on Image", () => LaunchImagePicker(DetectCreditCardFromImage)),
                new ListItemButton(this, "Detect Document Data on Image", () => LaunchImagePicker(DetectDocumentDataFromImage)),
                new ListItemButton(this, "Detect EU Health Insurance Card on Image", () => LaunchImagePicker(DetectEhicFromImage)),
                new ListItemButton(this, "Detect Medical Certificate on Image", () => LaunchImagePicker(DetectMedicalCertificateFromImage)),
                new ListItemButton(this, "Detect MRZ on Image", () => LaunchImagePicker(DetectMrzFromImage))
            ]);
