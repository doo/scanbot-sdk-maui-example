    ...
    public class FilterController : UIViewController
    {
        ...
        public FilterController()
        {
            ...
            [
                ...
                new FilterItem(nameof(SBSDKCustomBinarizationFilter), () => OnFilterSelected(new SBSDKCustomBinarizationFilter(outputMode: SBSDKOutputMode.Binary, denoise: 0.5, radius: 32, preset: SBSDKBinarizationFilterPreset.Preset1, strokeWeight:0.5))),
