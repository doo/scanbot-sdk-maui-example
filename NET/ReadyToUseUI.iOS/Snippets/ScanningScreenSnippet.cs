...
public class ScanningScreenSnippet : UIViewController
{
	...
	private void LaunchDocumentScanner()
	{
        ...
        cameraScreenConfig.TopUserGuidance.Background.FillColor = new SBSDKUI2Color(colorString: "#4A000000");
        cameraScreenConfig.TopUserGuidance.Title.Text = "Scan your document";
        
        // Configure the bottom user guidance.
        cameraScreenConfig.UserGuidance.Visibility = SBSDKUI2UserGuidanceVisibility.Enabled;
        cameraScreenConfig.UserGuidance.Background.FillColor = new SBSDKUI2Color(colorString: "#4A000000");
        ...
        cameraScreenConfig.ScanAssistanceOverlay.BackgroundColor = new SBSDKUI2Color(colorString: "#4A000000");
        cameraScreenConfig.ScanAssistanceOverlay.ForegroundColor = new SBSDKUI2Color(colorString: "#FFFFFF");
        ...
        cameraScreenConfig.CaptureFeedback.SnapFeedbackMode = new SBSDKUI2PageSnapCheckMarkAnimation();
